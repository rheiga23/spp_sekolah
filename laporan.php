...
<div class="container">
  ...
  <button type="button" class="btn btn-success mb-3" data-bs-toggle="modal" data-bs-target="#cetakLaporan">
                CETAK
  </button>
  </div>
</nav>
            ...
            <th>Tanggal</th>
               ...
               <?php
                require 'koneksi.php';
                $query = mysqli_query($koneksi,"SELECT tagihan.id_tagihan, tagihan.bulan, tagihan.keterangan, 
                tagihan.nominal_tagihan, tagihan.dibuat_pada, tagihan.siswa_id, 
                siswa.nama_siswa,siswa.nis, tahun_ajaran.tahun_ajaran, tagihan.dibuat_pada, 
                kelas.nama_kelas, program_studi.nama_prodi, tahun_ajaran.tahun_ajaran 
                FROM tagihan 
...
<!-- Modal Tambah -->
<form action="cetaklaporan/cetaklaporan.php" method="post">
