...
<div class="container">
    <h1 class="text-center"> LAPORAN LUNAS </h1>
  ...
  <button type="button" class="btn btn-success mb-3" data-bs-toggle="modal" data-bs-target="#cetakLunas">
                CETAK
            </button>
  </div>
</nav>
            ...
            <th>Tanggal</th>
               ...
               <?php
                ...
                WHERE tagihan.keterangan = 'Lunas'");
...
<!-- Modal Tambah -->
<form action="cetaklaporan/cetaklunas.php" method="post">
                    <div class="modal fade" id="cetakLunas" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
